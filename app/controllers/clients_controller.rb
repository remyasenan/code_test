class ClientsController < ApplicationController
	...
	def create
		...
		if @client.valid?
          ...
          headers: {
            'Content-Type' => 'application/multipart_form-data',
            'charset' => 'utf-8'
          }
      })
	...
	private
	 ...
	 def interpret_response(response)
	    ...
	    if response.code == 201
	      flash[:success] = "#{@client.name}, Thank you for your submission!" \
	                        " Make it cheaper executive will contact you back soon"
